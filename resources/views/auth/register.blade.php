                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="email"  name="name" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="checkbox text-white">
                                        ...
                                        <label for="terms">I agree to the <a href="#" class="text-warning"><b>Terms</b></a></label>
                                    </div>
                                </div>
                                <!-- /.col -->
