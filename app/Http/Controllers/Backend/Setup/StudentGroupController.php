...
class StudentGroupController extends Controller
{
    ...
    {
        $validatedData = $request->validate(['name' => 'required|unique:student_groups,name',]);
    ...
    public function StudentGroupUpdate(Request $request, $id)
    {
        ...
        $validatedData = $request->validate(['name' => 'required|unique:student_groups,name,' . $data->id]);
