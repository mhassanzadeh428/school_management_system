...
class SchoolSubjectController extends Controller
{
    ...
    {
        $validatedData = $request->validate(['name' => 'required|unique:school_subjects,name',]);
    ...
    public function SchoolSubjectUpdate(Request $request, $id)
    {
        ...
        $validatedData = $request->validate(['name' => 'required|unique:school_subjects,name,' . $data->id]);
        ...
        $notification = array(
            'message' => 'Schoo Subject Updated Successfully',
            'alert-type' => 'success'
