...
class FeeCategoryController extends Controller
{
    ...
    {
        $validatedData = $request->validate(['name' => 'required|unique:fee_categories,name',]);
    ...
    public function FeeCatUpdate(Request $request, $id)
    {
        ...
        $validatedData = $request->validate(['name' => 'required|unique:fee_categories,name,' . $data->id]);
