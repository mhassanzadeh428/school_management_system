...
class StudentShiftController extends Controller
{
    ...
    {
        $validatedData = $request->validate(['name' => 'required|unique:student_shifts,name',]);
    ...
    public function StudentShiftUpdate(Request $request, $id)
    {
        ...
        $validatedData = $request->validate(['name' => 'required|unique:student_shifts,name,' . $data->id]);
